...
Are there any differences in the attack, defense and healt points between one and other pokemon?
...
There is a navigation bar right at the top with a button in the center of it called "info", if you click it you will get a sense of what is this site about. Also I mantion that if yo click on very graph, all the other graphs in the page will be immediately modified to show you data exclusively related on the topic you just clicked. 
...
- As a user I want to know since he very beginning what is the website about.
- As a user I want I want to see clear and easy to read charts.
...
- As a user I want to see the a specific chart for the attack property. 
- As a user I want to see the a specific chart for the defense property. 
- As a user I want to see a conclusion right at the end about which one is most powerful. 

As the world of pokemon is big with many many charachters, I give relevance to charts that show what the user wants to know and the user in this case is mostly intereed on knowing which pokemon is more powerful or expanding the knowledge, which type of pokemon is the most powerful.

I took the structure of my project from a combination of two diferent project. One from a project done prior to this one in the Code Institute topic called "*Data visualization mini project*" from the "*Interactive Frontend Development*" unit and also from a project made by a Code Institute student with GitHub profile [RobSimons1](https://github.com/RobSimons1) and the following link to the project: [global-white-shark-attack-dashboard](https://github.com/RobSimons1/global-white-shark-attack-dashboard).
...
## Features
This web page can be looked and analized by different ways.
It can be seen generally comparing all the different types of pokemons all together.
It can be also seen as a story in which, since the beginning you choose what you want to focuse in and then you scroll down looking and analyzing the selected situation in all the different charts/sections. 
...
* **Average Spped:** Same as above but with the speed of each type of pokemon.
...
* **Footer:** This section has the ability to take the user up to the top again. It contains a contact button to send me an email whaterver the request and it also contain social media links to go and follow me. 
...
- CSS: to style the content regardig colors, size.
...
With the use of Bootstrap which focuses mainly on small screens has facilitated things a litle bit. All the paragraphs and charts have been done with the intention to perfect fit all the sizes available of screens, since mobile phones to computer screens. 
...
#### Client stories testing:
 ...
 - Then the user will be able to notice which are the most powerful types of pokemos, and its main characters. 
 - The user will have special approach to attack, defense and healt points which are the most important properties of a pokemon, besides to the type of pokemon.
 - At the end the user will get a final conlusion of the foundings od the project. 
...
- The Title and percentages section was test in different formats, the percentages below, as a column, the selector at the right, right next to the title, and finally got the current shape which is elegant and smple.
...
|   2    |The first csv file downloaderd did not have the "Total" column |Added the "Total" column at the end with the resulting of summing up all the existant columns.|
|   3   |Building up the charts I didnt have clear the process to obtain them.|I went to the Code Institute videos showing step by step on how to build DC charts and followed them.|
|   4   |Building up percentages I didnt know how to get a percentage from the total number of cases using a var.|After research, found out was easier to put the total number insted.|
...
|   7   |Wanted to add the attack power of each character but there are too many.|Found that using averages by type was a good option to get a feeling of the power of ech pokemon depending its type.|
|   8   |Same problem above with "Defense", "Healt Points".|It is very difficult to show the power of each one of the examples, so the best way is to use averages by type which is the best identifier.|
...
|   11  |Jquery was not working for the "info" button in the nav bar.|Went back to the Jquery topic in the Code Institute course and find out I was lacking a function in the beginning.|
...
1. Log into GitHub.
2. From the list of repositories available, **** was selected.
...
- The graphs on the web page were constructed by me but with the help of:
    ...
    - Styling and many other functions were possible to achieve thanks to: [W3Schools.com](https://www.w3schools.com/) and [Stack Overflow](https://stackoverflow.com/).

#### Media

- The csv pokemon file was extracted from [Keith Galli](https://github.com/KeithGalli) from his [Pandas repository](https://github.com/KeithGalli/pandas).
...
Special thanks to [Rob Simons](https://github.com/RobSimons1) who's White Shark project was an inspiration for me and help me doing this difficult project. Also to Code Institute and its instructive videos specially from the the "*Interactive Frontend Development*" unit. 